$(function (e) {
        ...
        series: [
            {
                name: "Total Revenue",
                data: [
                    0, 45, 54, 38, 56, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35,
        ...
        series: [
            {
                ...
                data: [
                    0, 45, 93, 53, 61, 27, 54, 43, 19, 46, 54, 38, 56, 24, 65,
                    31, 37, 39, 62, 51, 35, 41, 35, 27,
                ],
            },
        ],
        yaxis: {
        ...
        series: [
            {
                name: "Expenses",
                data: [
                    0, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46, 45, 54,
                    38, 56, 24, 65, 31, 37, 39, 62, 51,
                ],
            },
        ],
        yaxis: {
    ...
    /* sparkline_bar11 */
    $(".sparkline_bar11").sparkline(
        [
            2, 4, 3, 4, 5, 4, 5, 3, 4, 5, 2, 4, 5, 4, 3, 5, 4, 3, 4, 5, 4, 5, 4,
            3, 5, 4, 3, 4, 5,
        ],
        {
            type: "bar",
    ...
    $(".sparkline_bar12").sparkline(
        [
            3, 5, 4, 4, 5, 4, 5, 3, 4, 5, 3, 4, 5, 4, 3, 5, 4, 3, 4, 5, 4, 5, 4,
            3, 5, 4, 3, 4, 5,
        ],
        {
            type: "bar",
