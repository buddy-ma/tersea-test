    ...
    Plugin.prototype = {
                ...
                if (that.countryList.hasClass("hide")) {
                    ...
                    $(document).bind("keydown.intlTelInput", function (e) {
                        ...
                        if (e.which == 38 || e.which == 40) {
                            var current = that.countryList
                                .children(".highlight")
                                .first();
                            var next =
                                e.which == 38 ? current.prev() : current.next();
                            if (next) {
                                // skip the divider
                            ...
                            var countries = that.countryListItems.filter(
                                function () {
                                    return (
                            ...
                            if (countries.length) {
                                ...
                                var highlightedCountry = countries
                                    .filter(".highlight")
                                    .first();
                                var listItem;
        ...
        _appendListItems: function (countries, className) {
            ...
            $.each(countries, function (i, c) {
                ...
                tmp +=
                    "<span class='dial-code'>+" + c["calling-code"] + "</span>";
                // close the list item
                tmp += "</li>";
            });
