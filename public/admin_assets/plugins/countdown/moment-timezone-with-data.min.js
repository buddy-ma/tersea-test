!(function (c, M) {
    ...
    function L(c, M) {
        for (var z, A; (A = 6e4 * (((M.at - c.at) / 12e4) | 0)); )
            (z = new a(new Date(c.at + A))).offset === c.offset
                ? (c = z)
                : (M = z);
        return c;
    }
    ...
    function t(M) {
        ...
        return (
            b && !c.isMoment(M) && l(o) && o.add(b.parse(o), "minutes"),
            o.tz(A),
            o
        );
    }
    ...
    return (
        ...
        r({
            ...
            links: [
                ...
                "America/Port_of_Spain|America/Poppins",
