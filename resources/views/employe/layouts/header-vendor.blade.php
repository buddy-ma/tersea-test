          ...
          <div class="container-fluid">
              <div class="d-flex">
                  <a class="header-brand" href="{{ url('/' . ($page = '')) }}">
                      <img src="{{ URL::asset('admin_assets/images/brand/infodat.png') }}"
                          class="header-brand-img desktop-lgo" alt="Ariba logo">
                      <img src="{{ URL::asset('admin_assets/images/brand/logo1.png') }}"
                          class="header-brand-img dark-logo" alt="Ariba logo">
                      <img src="{{ URL::asset('admin_assets/images/brand/info.png') }}"
                          class="header-brand-img mobile-logo" alt="Ariba logo">
                      <img src="{{ URL::asset('admin_assets/images/brand/favicon1.png') }}"
           ...
           <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                              <div class="text-center">
                                  <a href="{{ url('/' . ($page = '#')) }}"
                                      ...
                                      {{ $store_name->name ?? '' }} &nbsp;</a>
                                  <span
                                      class="text-center user-semi-title">{{ Auth::guard('vendor')->user()->firstname ?? '' }}
                                      {{ Auth::guard('vendor')->user()->lastname ?? '' }}</span>
            ...
            <a class="dropdown-item d-flex" href="{{ url('/' . ($page = '#')) }}">
             ...
             <div class="">Messages</div>
                              ...
                              <a class="dropdown-item d-flex" href="{{ route('vendor.logout') }}"
