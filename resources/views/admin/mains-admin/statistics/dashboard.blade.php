                        ...
                        <ul class="timeline mb-0">
                            <li class="mt-0">
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Joseph Ellison</span> finished
                                    task on<a href="{{ url('/' . ($page = '#')) }}" class="font-weight-semibold">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Sonia Peters</span> finished
                                    target on<a href="{{ url('/' . ($page = '#')) }}" class="font-weight-semibold">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Ella Lambert</span> ontime order
                                    delivery <a href="{{ url('/' . ($page = '#')) }}" class="font-weight-semibold">Service
                                        Management</a></p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Richard Mills</span> source
                                    report on<a href="{{ url('/' . ($page = '#')) }}" class="font-weight-semibold">
                                        Generated</a></p>
                            </li>
                            <li class="mb-0">
                ...
                <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="{{ URL::asset('admin_assets/images/users/1.jpg') }}" alt="img"
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="{{ URL::asset('admin_assets/images/users/9.jpg') }}" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="{{ URL::asset('admin_assets/images/users/2.jpg') }}" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="{{ URL::asset('admin_assets/images/users/11.jpg') }}" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="{{ URL::asset('admin_assets/images/users/3.jpg') }}" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                                            <h6 class="mb-1">Joseph Abraham</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="country-card">
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/us.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/in.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/ru.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/ca.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/ge.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/br.svg') }}"
                        ...
                        <div class="mb-0">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('admin_assets/images/flags/au.svg') }}"
                        ...
                        <div>
                            ...
                            <h2 class="mb-0"><span class="number-font1">12,769</span><span
                                    class="ml-2 text-muted fs-11"><span class="text-danger"><i
                                            class="fa fa-caret-down"></i> 43.2</span> this month</span></h2>
                            ...
                            <tbody>
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/7.jpg') }}" alt="media1">
                                        New Book</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/8.jpg') }}" alt="media1">
                                        New Bowl</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/9.jpg') }}" alt="media1">
                                        Modal Car</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/10.jpg') }}" alt="media1">
                                        Headset</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/12.jpg') }}" alt="media1">
                                        Watch</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/13.jpg') }}" alt="media1">
                                        Branded Shoes</td>
                                ...
                                <tr class="mb-0">
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="{{ URL::asset('admin_assets/images/orders/11.jpg') }}" alt="media1">
                                        New EarPhones</td>
