    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide mt-3">
            <a class="side-menu__item" data-toggle="slide">
                ...
                <span class="side-menu__label">Companies</span><i class="angle fa fa-angle-right"></i>
            </a>
            <ul class="slide-menu">
                <li>
                    <a class="slide-item" href="{{ url('/admin/companies') }}">All Companies</a>
                </li>
                <li>
                    <a class="slide-item" href="{{ url('/admin/companies/add') }}">Add Company</a>
                </li>
            </ul>
        </li>
        <li class="slide mt-3">
            <a class="side-menu__item" href="{{ url('/admin/invitations') }}">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                    height="24" viewBox="0 0 24 24" width="24">
                    <path d="M0,0h24v24H0V0z" fill="none" />
                    <path
        ...
        <li class="slide mt-3">
            <a class="side-menu__item" href="{{ url('/admin/historique') }}">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                    height="24" viewBox="0 0 24 24" width="24">
                    <path d="M0,0h24v24H0V0z" fill="none" />
                    <path
                ...
                <span class="side-menu__label">Historique</span>
            </a>
        </li>
    </ul>
</aside>
